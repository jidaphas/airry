...
class Spline extends Component {
    ...
    render() {
        return (
            <Content className="site-layout" style={{ padding: 24, background: '#CCFFFF', minHeight: 1200}}>
                <div style={{  padding: 21, background: '#CCFFFF', minHeight: 710 }}>
                <h1 style={{ textAlign: 'margin-right : 150'}}>Spline Interpolation</h1>
                <div>
                    <div className="col"onChange={this.handleChange} style = {{textAlign: 'center',fontSize:'21px'}}>
                            ...
                            {this.state.showTableInput &&
                                <div>
                                    ...
                                    <Button
                                        id="matrix_button"
                                        size="large"style={{ width: 150 ,color: '#CCFFFF', background: '#660000' }}
