...
class Gauss extends Component {
    ...
    gauss(n) {
        this.initMatrix() // เอา array A[],B[] มาคิด
        if (A[0][0] === 0) { //pivoting
    ...
    render() {
        return (
            <Content className="site-layout" style={{ padding: 24, background: '#CCFFFF', minHeight: 1200}}>
                <div className="col"style={{ padding: 21, background: '#CCFFFF', minHeight: 710  }}>
                    <h1 style={{ textAlign: 'margin-right : 150' }}>Gauss Elimination</h1>
                    <div >
